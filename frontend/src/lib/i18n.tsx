...
const translations = {
  en: {
    ...
    'about.v1.desc': 'Initial scoring model using z-score normalization and percentile-based tier assignment. Fixed distribution forced 10% into each extreme tier regardless of actual quality.',
    'about.v2.title': 'v2 · Absolute Rating + Relative Ranking',
    'about.v2.desc': 'Replaced z-score with piecewise linear breakpoints for absolute 0-100 scoring. Separated rating (absolute quality) from ranking (relative position).',
    'about.v3.title': 'v3 · Qualitative 4-Dimension Model',
    'about.v3.desc': 'Introduced four investment dimensions: Earnings Visibility, Valuation Margin, Catalyst Timeline, and Downside Control. Added EMA smoothing and hysteresis.',
    'about.v4.title': 'v4 · Sector-Aware Breakpoints',
    'about.v4.desc': 'Financial-sector-specific scoring breakpoints to fix systematic over-scoring of banks and insurers.',
    'about.v5.title': 'v5 · Fundamental Scoring Overhaul',
    'about.v5.desc': 'Expanded sector-aware scoring to 6 sectors. Added FCF yield, current ratio, forward PE, and sector-adjusted growth expectations.',
    'about.v6.title': 'v6 · Technical Scoring Overhaul',
    'about.v6.desc': 'Price-normalized MACD, direction-aware volume, true volatility measurement, margin-weighted trend alignment, and per-dimension EMA smoothing.',
    'about.v7.title': 'v7 · Signal Validation & Data Quality',
    'about.v7.desc': 'Per-metric IC tracking for predictive validation, directional missing-data defaults, and data completeness scoring with composite penalty.',
    'about.v8.title': 'v8 · Analyst Revision Momentum',
    'about.v8.desc': 'Sell-side analyst revision momentum as a dedicated signal: revision direction, target price upside, and consensus rating.',
    'about.v9.title': 'v9 · Intelligence Upgrade',
    'about.v9.desc': 'Sentiment time decay with source credibility weighting, headline count normalization, and macro regime detection with regime-conditional dimension weights.',
    'about.v10.title': 'v10 · Trend Dashboard',
    'about.v10.desc': 'Sector-level trend analysis with 11 SPDR ETFs. Relative strength, breadth, analyst revisions, momentum, and volume signals with historical trend tracking.',
  ...
  zh: {
    ...
    'about.v1.desc': '初始评分模型，使用 z-score 标准化和百分位分层。固定分布导致无论实际质量如何，每个极端层级都强制分配 10% 的标的。',
    'about.v2.title': 'v2 · 绝对评级 + 相对排名',
    'about.v2.desc': '用分段线性断点替代 z-score，实现绝对 0-100 评分。将评级（绝对质量）与排名（相对位置）分离。',
    'about.v3.title': 'v3 · 定性四维模型',
    'about.v3.desc': '引入四个投资维度：盈利可见性、估值安全边际、催化剂时间线、下行控制。加入 EMA 平滑和迟滞机制。',
    'about.v4.title': 'v4 · 板块感知断点',
    'about.v4.desc': '为金融板块定制评分断点，修正银行和保险公司的系统性高估问题。',
    'about.v5.title': 'v5 · 基本面评分升级',
    'about.v5.desc': '板块感知评分扩展至 6 个板块。新增自由现金流收益率、流动比率、远期 PE 及板块调整后的增长预期。',
    'about.v6.title': 'v6 · 技术面评分升级',
    'about.v6.desc': '价格归一化 MACD、方向感知成交量、真实波动率度量、边际加权趋势对齐及逐维度 EMA 平滑。',
    'about.v7.title': 'v7 · 信号验证与数据质量',
    'about.v7.desc': '逐指标 IC 跟踪用于预测性验证，方向性缺失数据默认值，以及数据完整性评分与综合惩罚。',
    'about.v8.title': 'v8 · 分析师修正动量',
    'about.v8.desc': '卖方分析师评级修正动量作为独立信号：修正方向、目标价上行空间和共识评级。',
    'about.v9.title': 'v9 · 智能升级',
    'about.v9.desc': '舆情时间衰减与来源可信度加权、标题数量归一化，以及宏观状态检测与状态条件维度权重。',
    'about.v10.title': 'v10 · 趋势看板',
    'about.v10.desc': '基于 11 只 SPDR 板块 ETF 的板块级趋势分析。包含相对强度、市场宽度、分析师修正、动量和成交量信号，支持历史趋势追踪。',
