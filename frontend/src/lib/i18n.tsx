...
const translations = {
  en: {
    ...
    'about.scoringFormula': 'Composite = 40% × Fundamental + 35% × Technical + 25% × Sentiment',
    ...
    'about.fundSubWeights': 'Value 30% + Quality 30% + Growth 25% + Safety 15%',
    'about.techSubWeights': 'Trend 40% + Momentum 30% + Volatility 15% + Volume 15%',
  ...
  zh: {
    ...
    'about.scoringFormula': '综合得分 = 40% × 基本面 + 35% × 技术面 + 25% × 舆情',
    'about.scoringSmoothing': '对综合得分施加 EMA 平滑（α=0.3）以减少每日噪音。子因子得分保持原始值，便于归因分析。',
    'about.fundSubWeights': '估值 30% + 质量 30% + 成长 25% + 安全 15%',
    'about.techSubWeights': '趋势 40% + 动量 30% + 波动 15% + 量能 15%',
