...
const translations = {
  en: {
    ...
    'about.scoringComposite': 'The composite score is the weighted average of the three factor scores (all 0–100):',
    'about.scoringFormula': 'Composite = 50% × Fundamental + 30% × Technical + 20% × Sentiment',
  ...
  zh: {
    ...
    'about.scoringComposite': '综合得分是三个因子得分（均为 0–100）的加权平均：',
    'about.scoringFormula': '综合得分 = 50% × 基本面 + 30% × 技术面 + 20% × 舆情',
