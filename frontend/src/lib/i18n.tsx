...
const translations = {
  en: {
    ...
    'about.modelHistoryDesc': 'The scoring model has gone through 4 iterations, each addressing issues discovered in the previous version.',
  ...
  zh: {
    ...
    'about.modelHistoryDesc': '评分模型经历了 4 次迭代，每次都针对上一版本中发现的问题进行改进。',
    'about.historyV1Label': 'v1',
    'about.historyV1Date': '2026-02-01',
